    ...
    def form_valid(self, form):
        ...
        if form.instance.status == 1:
            messages.success(self.request,
                             "You have successfully published the blog post.")
        elif form.instance.status == 0:
            messages.success(self.request,
                             "Your blog post is set to draft.")
        else:
            messages.success(self.request,
                             "You have created your blog post."
...
class PostUpdate(UpdateView):
    ...
    def form_valid(self, form):
        ...
        if form.instance.status == 1:
            messages.success(self.request,
                             "You have updated the blog post to published.")
        elif form.instance.status == 0:
            messages.success(self.request,
                             "Your blog post update is set to draft.")
        else:
            messages.success(self.request,
                             "You have updated your blog post.")
        return response
...
class PostDelete(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        messages.success(request,
                         "You have successfully deleted your blog post.")
        return response
